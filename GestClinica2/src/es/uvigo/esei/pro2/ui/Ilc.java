...
public class Ilc {
    ...
    public void ler() {
        ...
        int maxCitas = leeNum("Num. max. citas medicas: ");
        String nombre = leeString("Nombre de la clínica");

        // Prepara
        Clinica coleccion = new Clinica(maxPacientes, maxMedicos, maxCitas, nombre);
    ...
    private void modifica(Object o, Clinica coleccion) throws Exception {
        ...
        if (o instanceof CitaMedica) {
            ...
            for (int i = 0; i < coleccion.getNumMedicos(); i++) {
                System.out.println(i + " " + coleccion.getMedicos()[i] + "\n");
            }
            ...
            for (int i = 0; i < coleccion.getNumPacientes(); i++) {
                System.out.println(i + " " + coleccion.getPacientes()[i] + "\n");
            }
